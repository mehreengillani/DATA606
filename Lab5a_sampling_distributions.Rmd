...
In a sample of 50 people, 74% (37) believed scientists benefited them, while 26% (13) say scientists don't benefit. This sample distribution (74/26) differs from the known population ratio of 80/20.
...
In the second sample of 50 people, 84% (42 individuals) reported that scientists benefit them, while 16% (8 individuals) felt scientists do not provide benefits. This result is different than first sample result. So I believe my classmates are getting different results than mine. 
...
samp3 %>%
  ...
  mutate(s3 = n /sum(n))
```
In the sample of 100 people, 81% (81 individuals) reported that scientists benefit them, while 19% (19 individuals) felt scientists do not provide benefits.
...
In the sample of 1000 people, 79.8% (798 individuals) reported that scientists benefit them, while 20.2% (202 individuals) felt scientists do not provide benefits.
...
min(sample_props50$p_hat)
max(sample_props50$p_hat)
```
There are <b>15,000</b> elements in Sample_props50<br>
The mean of p_hat is <b>0.1992</b><br>
sampling distribution follows normal distribution with <b>min-max vlaues 0.02 - 0.42</b><br>
...
ggplot(data = sample_props_small, aes(x = p_hat1)) +
  geom_histogram(binwidth = 0.02) +
  labs(
    x = "p_hat (Doesn't benefit)",
    title = "Sampling distribution of p_hat",
...
message('Number of elements in sample_props_small is: ', nrow(sample_props_small))
message('mean for p_hat is: ', mean(sample_props_small$p_hat1))
message('min for p_hat is: ', min(sample_props_small$p_hat1))
message('max for p_hat is: ', max(sample_props_small$p_hat1))
```
...
for sample size 10, number of sample 15000 and 5000 <br>
Mean of sampling distribution = 0.22<br>
SE of sampling distribution = 0.11<br>

for sample size 50, number of sample 5000 <br>
Mean of sampling distribution = 0.2<br>
SE of sampling distribution = 0.06<br>

for sample size 100,number of sample 5000<br>
Mean of sampling distribution = 0.2<br>
SE of sampling distribution = 0.04<br>

1. The mean converges to the true population proportion (0.20) as sample size increases. when sample size was 10 mean value was 0.2. Whereas when sample size was 50 or 100 mean was equal to population mean. <br>

2. Standard deviation decreases as sample size increases. <br>
SE was 0.11 when sample size was 10, SE = 0.06 for Sample Size 50 <br>
and SE = 0.04 for sample size 100<br>

3. Shape: The distribution becomes more normal and less variable as sample size increases<br>
At n=100, the sampling distribution is approximately normal

More simulations = more precise estimates of the sampling distribution parameters<br>
The mean and SE values become more stable and reliable<br>
The shape becomes smoother but the center and spread don't systematically change<br>
...
7.  Take a sample of size 15 from the population and calculate the proportion of 
    ...
    of people who think the work scientists do enchance their lives?
...
<b>Shape for n=150:</b><br>

Nearly symmetric: Mean (0.8011) close to Median (0.8000)<br>
Approximately normal: The symmetry and tight clustering suggest a normal-like distribution<br>
Low variability: The distribution is concentrated around 0.80<br>

<b>Shape for n=15:</b><br>
Higher variability: Values range from 0.40 to 1.00<br>
Slightly right-skewed: Mean (0.7992) < Median (0.8000)<br>

Larger samples (n=150) produce more precise estimates with less variability. Min max of p_hat for sample size 150 is 0.693, 0.913 respectively <br>
Smaller samples (n=15) are more volatile and can produce extreme estimates. min max of p_hat for sample size 15 is 0.4, 1 respectively <br>
Both converge around the same central value (0.80), suggesting this is the true population parameter. For sample size 15 p_hat mean value is 0.7992
whereas for sample size 150 p_hat mean value is 0.801.

Conclusion: The true proportion of people who think scientists' work enhances their lives is likely 80%, with the n=150 sample giving us much greater confidence in this estimate
...
The sampling distribution with n=150 has a much smaller spread as compared to sample size 15 sampling distribution.<br>
The n=150 distribution has smaller range(0.22) than sample size 15 (0.6).<br>

I would strongly prefer a sampling distribution with a small spread when trying to make estimates close to the true value <br>

<b>Small spread gives Higher Precision:</b> A smaller spread means your sample estimates are consistently closer to the true population parameter.<br>

<b>More Reliability:</b> With n=150, most samples give estimates between 0.78 and 0.82 Q1, Q3 respectively, while n=15 gives estimates ranging from 0.733 to 0.866 Q1 and Q3 respectively <br>

<b>Greater Confidence:</b> You can be more certain that any given sample will provide an estimate near the true value
* * *
